    ...
    <div className={`${isExpanded == true ? 'expanded' : 'sidebar'}`}>
        ...
        {isExpanded == true && (
            ...
            <div className="d-flex mt-2 cursor-pointer justify-content-between align-items-start">
                <h5 className="mx-3 my-2">Seller Panel</h5>
            ...
            <div className="d-flex justify-content-center align-items-start flex-column">
                <div className="category-sidebar px-3" onClick={() => navigate('/seller')}>Dashboard</div>
                <div className="category-sidebar px-3" onClick={() => navigate('/seller/shop/new')}>New Shop</div>
                <div className="category-sidebar px-3" onClick={() => navigate('/seller/profile')}>Profile</div>
